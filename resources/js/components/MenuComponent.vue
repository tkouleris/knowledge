<template>
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="" class="brand-link">
            <img src="" alt="Logo" class="brand-image img-circle elevation-3" :src="logo" style="opacity: .8">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img :src="user_image" @error="imageLoadError" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a :href="url_dashboard" class="nav-link">
...
export default {
    ...
    data: function() {
        return {
            ...
            user_image: window.location.origin + '/img/avatar/'+localStorage.id+'/avatar.jpg',
    ...
    methods:{
        imageLoadError: function (){
            this.user_image = window.location.origin + '/img/user.jpg'
        }
    }
}
</script>
